...
export type GlassSignUpCardProps = {
...
export function GlassSignUpCard({
  ...
  return (
    <motion.div
      ...
      className="group relative w-full overflow-hidden rounded-3xl border border-border/60 bg-card/85 p-8 backdrop-blur-xl sm:p-12"
